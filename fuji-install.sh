#!/bin/bash
#
# Ich teste hier nur. Diese Datei kann ja bald eh gelöscht werden
# mbo 
...
echo ""
echo "Install structorizer"
wget -0 ~/Downloads/structorizer.deb https://people.debian.org/~debalance/structorizer/current/structorizer_3.22-2_all.deb
sudo gdebi -n ~/Downloads/structorizer.deb
echo ""
